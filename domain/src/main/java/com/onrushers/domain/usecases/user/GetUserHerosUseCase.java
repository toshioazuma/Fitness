...
public class GetUserHerosUseCase extends UseCase implements GetUserHerosInteractor {
	...
	@Inject
	public GetUserHerosUseCase(AuthSessionRepository authSessionRepository,
			...
			.flatMap(new Func1<IAuthSession, Observable<IPagination>>() {
				...
				public Observable<IPagination> call(IAuthSession authSession) {
					...
					return mUserRepository
						.getUserHeros(userId, mPage, mPageCount, authSession.getToken());
				}
			});
	}
